...
*/
__global__ void addBlockSumsToOriginal(Tensor1D<unsigned int>* blockPrefixSums, Tensor1D<unsigned int>* blockTotalSums,Tensor1D<unsigned int>* prefixSums) {
...
*/
__global__ void getBlockTotals(Tensor1D<unsigned int>* blockPrefixSums, Tensor1D<unsigned int>* blockTotalSums) {
...
Tensor1D<unsigned int>* prefixSum(Tensor1D<unsigned int>* input) {
   ...
   // =================================================================================================
   Tensor1D<unsigned int>* blockPrefixSums = blockPrefixSumsKoggeStone(input);
   ...
   // =================================================================================================
   Tensor1D<unsigned int>* blockTotals = new Tensor1D<unsigned int>(gridXBlockTotal);
   ...
   Tensor1D<unsigned int>* blockTotalSums = blockPrefixSumsKoggeStone(blockTotals);

   // kernel 4: add the summed block totals to the original input to produce the final prefix sums vector
   // =================================================================================================
   Tensor1D<unsigned int>* prefixSums = new Tensor1D<unsigned int>(input->totalSize);
