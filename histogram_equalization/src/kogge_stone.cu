...
*/
__global__ void blockPrefixSumsKoggeStone(Tensor1D<unsigned int>* input, Tensor1D<unsigned int>* output) {
...
Tensor1D<unsigned int>* blockPrefixSumsKoggeStone(Tensor1D<unsigned int>* input) {
    Tensor1D<unsigned int>* output = new Tensor1D<unsigned int>(input->totalSize);
